...
class _ForgetPasswordApiClient implements ForgetPasswordApiClient {
  ...
  @override
  Future<ForgetPasswordResponse> forgetPassword(dynamic body) async {
  ...
  @override
  Future<VerifyResetCodeResponse> verifyResetCode(dynamic body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  @override
  Future<ResetPasswordResponse> resetPassword(dynamic body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
